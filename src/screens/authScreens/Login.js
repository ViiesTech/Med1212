        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1, }}>
            ...
            <View style={{ flex: 1, backgroundColor: '#E6E9FF', borderTopLeftRadius: 50, borderTopRightRadius: 50, marginTop: 30 }}>
                <View style={{ width: '100%', padding: 20, alignItems: 'center' }}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('mainStack')} style={{ backgroundColor: 'black', flexDirection: 'row', gap: 30, height: 60, width: '100%', borderRadius: 35, justifyContent: 'center', alignItems: 'center', marginTop: 15 }} >
                        <AntDesign name='apple1' color='white' size={25} />
                        <Text style={{ color: 'white', fontSize: 16 }} >Continue With Apple</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => navigation.navigate('mainStack')} style={{ backgroundColor: 'white', flexDirection: 'row', gap: 25, height: 60, width: '100%', borderRadius: 35, justifyContent: 'center', alignItems: 'center', marginTop: 15 }} >
                        <Image source={images.googleLogo} />
                        <Text style={{ color: 'black', fontSize: 16 }} >Continue With Google</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => navigation.navigate('mainStack')} style={{ backgroundColor: '#1878F3', flexDirection: 'row', gap: 30, height: 60, width: '100%', borderRadius: 35, justifyContent: 'center', alignItems: 'center', marginTop: 15 }} >
